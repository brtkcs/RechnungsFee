...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    datum: 'Juni 2026',
    eintraege: [
      { typ: 'fix', text: 'EÜR: Betriebseinnahmen (7 %) wurden fälschlich in Zeile 12 (19 % Regelsteuersatz) eingetragen statt in Zeile 13 (7 % ermäßigt); Betriebseinnahmen (0 %) landen jetzt korrekt in Zeile 11 (Kleinunternehmer §19 UStG); EUR_ZEILEN_META um Zeile 11 ergänzt und Bezeichnungen auf amtlichen Wortlaut korrigiert (Issue #185)' },
