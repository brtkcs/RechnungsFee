...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    eintraege: [
      ...
      { typ: 'verbesserung', text: 'Datumsfelder: Alle Datumsfelder akzeptieren jetzt direkte Tastatureingabe im Format TT.MM.JJJJ mit automatischer Punkt-Einfügung – kein nativer Datepicker mehr (Issue #196)' },
