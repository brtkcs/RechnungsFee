...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    eintraege: [
      ...
      { typ: 'verbesserung', text: 'Anlage G: ELSTER-KZ-Badges (KZ 10 Gewinn / KZ 11 Verlust) für laufende Einkünfte ergänzt; Z. 51 (Messbetrag) und Z. 52 (gezahlte Gewerbesteuer) immer sichtbar; Hebesatz-Feld neben Wirtschaftsjahr verschoben' },
