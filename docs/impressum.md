...
Die **PC-Wittfoot UG** ist **ausschließlich für die Verwaltung von Spenden** für das Open-Source-Projekt **[RechnungsFee](https://github.com/nicolettas-muggelbude/RechnungsFee)** verantwortlich.
Für den **Code, die Dokumentation oder die Nutzung des Projekts** haftet **nicht** die UG, sondern die jeweiligen Urheber:innen (siehe [AGPLv3](https://github.com/nicolettas-muggelbude/RechnungsFee?tab=AGPL-3.0-1-ov-file#)).
